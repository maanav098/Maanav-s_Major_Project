...
import {
  Briefcase, Users, Brain, Target, CheckCircle,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">AI-Powered Evaluation</h3>
            ...
            <div className="card hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Company-Specific Practice</h3>
              <p className="text-gray-600">
            ...
            <div className="card hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Level Prediction</h3>
              <p className="text-gray-600">
